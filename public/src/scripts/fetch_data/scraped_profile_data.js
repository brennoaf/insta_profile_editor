...
export class ScrapedProfileData {
    ...
    async fetchProfileData() {
        try {
            ...
            const scrapedProfileResponse = await fetch(`18.231.185.144:3001/scraped-profile?username=${username}`);
    ...
    async fetchPostData() {
        ...
        const scrapedPostResponse = await fetch(`18.231.185.144:3001/scraped-publications?username=${username}`);
